export const us = {
  us: {
    translation: {
      ...
      mainView: {
        titleText: "Work conveniently - VarnixGroup space",
        subtitleText:
        ...
        subscribeSubtext:
          "Receive the latest updates, news, and event announcements directly to your email",
        galleryTitle: "Gallery of Achievements",
        subtitleGallery: "Here are some highlights from our projects, classes, and events.",
      },
      coursesView: {
